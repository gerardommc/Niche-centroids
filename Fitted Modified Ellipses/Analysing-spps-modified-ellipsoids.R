...
dir.create("../Resultados/Analysis-centroids")
dir.create("../Resultados/Analysis-centroids/Fitted-mod-ellipses")

for(i in seq_along(all.ellips)){ 
      saveRDS(all.ellips[[i]], paste0("../Resultados/Analysis-centroids/Fitted-mod-ellipses/Mod-ellips-", i, ".rds"))
}