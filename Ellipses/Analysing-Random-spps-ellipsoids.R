...
dir.create("../Resultados/Analysis-centroids/Fitted-Random-Ellipses")

for(i in seq_along(all.ellips)){ 
      saveRDS(all.ellips[[i]], paste0("../Resultados/Analysis-centroids/Fitted-Random-Ellipses/Ellips-", i, ".rds"))
}
