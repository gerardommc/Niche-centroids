...
dir.create("../Resultados/Analysis-centroids/Fitted-Edge-Ellipses")

for(i in seq_along(all.ellips)){ 
      saveRDS(all.ellips[[i]], paste0("../Resultados/Analysis-centroids/Fitted-Edge-Ellipses/Ellips-", i, ".rds"))
}
