...
dir.create("../Resultados/Analysis-centroids/Fitted-Outer-Saturated-PPMs")

for(i in seq_along(spp.ppms)){
      saveRDS(spp.ppms[[i]], paste0("../Resultados/Analysis-centroids/Fitted-Outer-Saturated-PPMs/PPM-", i, ".rds"))
}
