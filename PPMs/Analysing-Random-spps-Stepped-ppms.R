...
dir.create("../Resultados/Analysis-centroids/Fitted-Random-Stepped-PPMs")

for(i in seq_along(spp.ppms)){
      saveRDS(spp.ppms[[i]], paste0("../Resultados/Analysis-centroids/Fitted-Random-Stepped-PPMs/PPM-", i, ".rds"))
}
