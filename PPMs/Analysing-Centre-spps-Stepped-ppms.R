...
dir.create("../Resultados/Analysis-centroids/Fitted-Centre-Stepped-PPMs")

for(i in seq_along(spp.ppms)){
      saveRDS(spp.ppms[[i]], paste0("../Resultados/Analysis-centroids/Fitted-Centre-Stepped-PPMs/PPM-", i, ".rds"))
}
