...
mahal.dists <- readRDS("Simulated-species/Mahal-dists-OuterCentroids.rds")
...
dir.create("../Resultados/Analysis-centroids/Fitted-Outer-Ellipses-NORM")

for(i in seq_along(all.ellips)){ 
      saveRDS(all.ellips[[i]], paste0("../Resultados/Analysis-centroids/Fitted-Outer-Ellipses-NORM/Ellips-", i, ".rds"))
}
