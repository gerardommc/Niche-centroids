...
df.results <- data.frame(df.centroids, vars.spp, approach = "PPM-sat", centr.conf = "centre")

write.csv(df.results, "Simulated-species/Results-CentreSaturatedPPMs.csv", row.names = F)
